...
class XilinxBscanSpi(xilinx.XilinxPlatform):
    packages = {
        ...
        ("fgg484-2l", 1): ["T19", None, "P22", "R22", "P21", "R21"],
        ...
        ("cpga196-1", 1): ["D13", None, "C10", "C11", "B11", "A12"],
        ("cpg236-1", 1): ["K19", None, "D18", "D19", "G18", "F18"],
        ("cpg238-1", 1): ["G19", None, "D18", "D19", "E19", "F19"],
    ...
    pinouts = {
        ...
        "xc7s6": ("cpga196-1", 1, "LVCMOS25", Series7),
        "xc7s15": ("cpga196-1", 1, "LVCMOS25", Series7),
        "xc7s25": ("csga324-1", 1, "LVCMOS25", Series7),
        "xc7s50": ("csga324-1", 1, "LVCMOS25", Series7),
        "xc7s75": ("fgga484-1", 1, "LVCMOS25", Series7),
        "xc7s100": ("fgga484-1", 1, "LVCMOS25", Series7),
        "xc7a100t": ("csg324-1", 1, "LVCMOS25", Series7),
        "xc7a100t": ("fgg484-2l", 1, "LVCMOS25", Series7),
